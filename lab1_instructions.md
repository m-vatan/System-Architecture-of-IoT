...
The lab work is graded based on a report submitted by the team at the end of last Lab (one report for all the labs).
Each lab
...
At the end of the report you should also provide a (collective) reflection on
...
The hard deadline for submission is ***22.03.2020 23:55***
...
For the Labs. your will use Vagrant as a development environment step. "Vagrant is a tool for building and managing virtual machine environments in a single workflow."

Its sufficient if one member of your group has his/her laptop setup.

It is assumed that you know some basic commands of git. If you don't or you need a quick refresher, check this link. Download and install the following software on your operating system.

* Git (https://git-scm.com/downloads)
* Vagrant (https://www.vagrantup.com/downloads.html)
* Virtualbox (https://www.virtualbox.org/wiki/Downloads)
* Only windows - SSH infrastructure. Something like this: https://putty.org/

Once installed, create a directory in a location of your choice. I will refer to this directory as the `project_home`. In your `project_home`, clone the following repository:

```
git clone https://gitlab.abo.fi/slafond/iot_labs
```
...
Your setup is complete if the following command executes without an error. Windows users may need additional setup. Check this link: https://tech.osteel.me/posts/2015/01/25/how-to-use-vagrant-on-windows.html

```
vagrant -X ssh
cd /vagrant
python3 test_vagrant.py
```
You should see a window with a video showing detected persons.

Finally, copy the content of the `id_rsa.pub` file from your `project_home/iot_labs` and upload it in moodle.

Note: **Don't use the public key of your laptop, but the one generated by your vagrant container.**
By default, Vagrant will share your project directory (the directory with the Vagrantfile) to /vagrant. You can use this folder to share content between the host computer and the vagrant virtual machine.
...
For the lab we will use Arduino IDE: [download it here](https://www.arduino.cc/en/Main/Software) and install the IDE on your machine.
...
1. On the attendance list:
    1. Check your name, e-mail address and group number are correct
    2. Sign the sheet for the date of the lab
    3. In the case you are not sure if you have a student number at ÅA, contact the teacher.
2. You have setup the vagrant container. Instructions for these are explained above.
